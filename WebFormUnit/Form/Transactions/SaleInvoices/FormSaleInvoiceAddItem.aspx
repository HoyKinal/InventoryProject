<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormSaleInvoiceAddItem.aspx.cs" Inherits="WebFormUnit.Form.Transactions.SaleInvoices.FormSaleInvoiceAddItem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="col-3">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="card-title text-primary">Sale Form</h5>
                        <p class="text-muted">Fill in information below to add a sale item to your invoice.</p>
                    </div>
                    <div class="card-body">
                        <div class="mt-0">
                    ...
                    <div class="card-footer text-end">
                        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" ValidationGroup="Save" Text="Save" OnClick="btnSave_Click" />
                    </div>
                </div>
            </div>
            <div class="col-9">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <h5 class="text-success">Invoice No:
                                    <asp:Label ID="lbDisplayInvoiceNo" runat="server" CssClass="text-success h5"></asp:Label>
                                </h5>
                    ...
                    <div class="card-body">
                        <asp:GridView ID="gvSaleInvoiceDetail" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="false"
                            EmptyDataText="Empty SaleReceipt Info here."
                            DataKeyNames="InvoiceCode"
                            OnRowDataBound="gvSaleInvoiceDetail_RowDataBound"  
                            OnRowCommand="gvSaleInvoiceDetail_RowCommand"
                           >
                            <Columns>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var subTotal = $('#' + '<%=txtGrandTotal.ClientID%>');
