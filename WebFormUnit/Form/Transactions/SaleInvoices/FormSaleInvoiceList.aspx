<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormSaleInvoiceList.aspx.cs" Inherits="WebFormUnit.Form.Transactions.SaleInvoices.FormSaleInvoiceList" %>
            ...
            <div class="col-3">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="text-primary">Find Sale Invoice</h5>
                        <p class="text-muted">Choose criteria below to filter your sale invoices</p>
                    </div>
                    <div class="card-body">
                        <div class="mt-0">
            ...
            <div class="col-9 mt-3">
                <asp:GridView ID="gvReceiptList" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="InvoiceDate" HeaderText="InvoiceDate" DataFormatString="{0:dd/MM/yyyy}" />
                        <asp:BoundField DataField="InvoiceNo" HeaderText="InviceNo" />
