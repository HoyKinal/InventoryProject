...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-start align-items-center bg-light p-3 rounded shadow-sm mb-4">
            <asp:LinkButton ID="btnOpenItem" runat="server" CssClass="btn btn-outline-primary me-2 mb-2 mb-md-0">
            ...
            <asp:LinkButton ID="btnDeleteItem" runat="server" CssClass="btn btn-outline-danger me-2 mb-2 mb-md-0">
            <i class="fi fi-ss-trash"></i> Delete
            </asp:LinkButton>
            <asp:LinkButton ID="btnSaveNewItem" runat="server" CssClass="btn btn-outline-primary me-2 mb-2 mb-md-0">
            <i class="fi fi-ss-disk"></i> Save New
            </asp:LinkButton>
            <asp:LinkButton ID="btnSaveCoseItem" runat="server" CssClass="btn btn-outline-primary mb-2 mb-md-0">
            <i class="fi fi-ss-bookmark"></i> Save Close
            </asp:LinkButton>
        </div>
        <!-- MainRow -->
        <div class="row g-3">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <asp:Label ID="lbAcount" runat="server" CssClass="fw-bold" Text="0"></asp:Label>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <asp:Label ID="lbGrandTotal" runat="server" CssClass="fw-bold" Text="0"></asp:Label>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            var textbox = document.getElementById('<%= txtExpenseNo.ClientID %>');
            disableTextSelection(textbox);
        });
