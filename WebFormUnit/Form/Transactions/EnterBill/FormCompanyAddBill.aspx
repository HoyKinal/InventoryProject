<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormCompanyAddBill.aspx.cs" Inherits="WebFormUnit.Form.Transactions.EnterBill.FormCompanyAddBill" %>
            ...
            <div class="row g-3">
                <div class="col-lg-3">
                    <div class="card shadow-sm">
                        <div class="card-header bg-primary text-white">
                            <h5 class="card-title mb-0">Bill Form</h5>
                            <small>Fill in information below to add a sale item to your bill.</small>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                ...
                <div class="col-lg-9">
                    <div class="card shadow-sm">
                        <div class="card-header bg-success text-white">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <small>List all your bill items below.</small>
                                </div>
                                <div class="col-6 text-end">
                                    <label class="h5 card-title text-light">Bill No: </label>
                        ...
                        <div class="card-body">
                            <asp:GridView ID="gvAddEnterBill" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="false"
                                EmptyDataText="Empty Information Item."
                                DataKeyNames="BillItemCode"
                                OnRowDataBound="gvAddEnterBill_RowDataBound"
                                OnRowCommand="gvAddEnterBill_RowCommand">
                                <Columns>
