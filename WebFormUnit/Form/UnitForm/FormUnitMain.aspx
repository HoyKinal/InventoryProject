<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormUnitMain.aspx.cs" Inherits="WebFormUnit.Form.UnitForm.FormUnitMain" %>
    ...
    <div class="wrapper">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-8 d-flex justify-content-end">
                        <asp:Button CssClass="btn btn-primary me-5" ID="btnAdd" runat="Server" Text="Add" OnClientClick="showAddModal();return false;" />
                    </div>
                </div>
            </div>
            <div class="card-body">
                <asp:GridView CssClass="table table-striped table-hover" ID="gvUnitMain" runat="Server" AutoGenerateColumns="False" DataKeyNames="UnitCode" OnRowCommand="gvUnitMain_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Actions" HeaderStyle-CssClass="text-end pe-5">
                            <ItemTemplate>
                                <div class="text-end">
                                    <%-- <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-primary" Text="Edit" CommandName="EditUnit" CommandArgument='<%# Eval("UnitCode") %>'></asp:LinkButton>--%>
        ...
        <div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModalLabel">Are you sure want to delete?
                        </h5>
                    </div>
                    <div class="modal-body">
                        <p class="card-title">Please if you want to delete this record.</p>
